...
#############
if (len(sys.argv) < 3):
    print("Usage:    python apply_change.py <input CMD file> <output BIP file>")
    sys.exit()

input_cmd = sys.argv[1]
output_bip = sys.argv[2]

#############
## 1) Compress file
#############
cmd = ['perl', 'compress-bip.pl', input_cmd, output_bip]
...
#############
shutil.copy(output_bip, unpacked_dir)
